...
public class MesReservationsServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        // code pour récupérer l'identifiant de l'utilisateur connecté
        HttpSession session = request.getSession();
        Utilisateur user = (Utilisateur) session.getAttribute("user");
        
        try {
            List<Reservation> resas = ReservationsDAO.reservations(ds, user.getIdentifiant());
            // ajout de cette liste comme attribut de la requête
