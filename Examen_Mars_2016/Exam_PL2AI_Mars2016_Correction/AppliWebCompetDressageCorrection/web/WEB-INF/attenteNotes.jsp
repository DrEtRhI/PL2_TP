...
<html>
    ...
    <body>
        <div id="container">
            ...
            <!--<img src="images/waiting.gif" width=80 height=40 align="middle">-->
            ...
            <table class="table table-bordered table-condensed">
                ...
                <%
                    ...
                    Resultat res = gestionnaire.getResultatCavalierEnPiste();
                ...
                <tr>
                    ...
                    <td>
                        <%
                            if (res.getNote(noJuge) != -1) {
                                out.println(res.getNote(noJuge));
                            } else {
                                out.println("<img src=\"images/waiting.gif\" width=80 height=40 align=\"middle\">");
                            }
