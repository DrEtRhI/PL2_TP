...
public class GestionnaireEpreuve {
    ...
    /**
     * le numéro (dans l'ordre de passage) du cavalier en piste.
     */
    private int noCavalierEnPiste = 0;
    ...
    /**
     * @return le numero du cavalier en piste. 
     */
    public int getNoCavalierEnPiste() {
        return noCavalierEnPiste;
    }
