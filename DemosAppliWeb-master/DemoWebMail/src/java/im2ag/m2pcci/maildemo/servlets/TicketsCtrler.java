 ...
 * l'acheteur, ensuite la servlet redirige la requête vers une page jsp
 * afin de confirmer "l'achat" et l'envoi du courriel ou d'afficher un
...
//       le lib du serveru tomcat. Mais sur les machines de l'ufr les étudiants n'ont
//       pas les droits adminsitrateur.
//       et ecrire ce fichier dans le répertoire nblib, de .netbeans ne suffit pas.
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            // (pas les droits adminstrateur) pour les étudiants ce n'est pas possible
            ...
            MailSender.sendMailWithAttachedFile(mailSession,
                    ...
                    "application/pdf");
            ticketEnvoye = true;
        } catch (IOException | COSVisitorException | MessagingException ex) {
            // le ticket n'a pas été envoyé
            // un message d'erreur sera envoyé à l'utilisateur
            // on affiche sur la console du serveur une trace pour permettre
            // à l'administrateur de comprendre la cause de l'erreur
            log("Erreur envoi du ticket " + ex.getMessage());
            ex.printStackTrace();
