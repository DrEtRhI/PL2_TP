...
//        d.ajouterObjet(new Cercle(1000, 500, 50, 8.5f, Color.orange, Color.magenta));
        ...
        // ajout visage avec déplacement circulaire
        d.ajouterObjet(new FormeAnimee(new VisageRond(d, 0, 0, 80, 80), new AnimateurCercle(700, 50, 80, 0, 10)));
        // ajout étoile et polygone avec déplacement cap
        d.ajouterObjet(new FormeAnimee(new PolygoneRegulier(3, 700, 400, 15, 10f, Color.blue, Color.red), new AnimateurCap(d, 20)));
        d.ajouterObjet(new FormeAnimee(new Etoile(10, 400, 80, 10f, Color.green, Color.blue), new AnimateurCap(d, -20)));
        
        // ajout visage avec déplacement chenille
        d.ajouterObjet(new FormeAnimee(new VisageRond(d), new AnimateurCap(d, -120)));
        
        // ajout chenille avec corps alétoire, déplacement cap
        d.ajouterObjet(new Chenille(d, new FormeAnimee(new Cercle(d.getLargeur() / 2, d.getHauteur() / 2, 20, 5f, Color.gray, Color.red), new AnimateurCap(d, 20)), 15, 10, true));
        // ajout chenille avec corps standard, déplacement circulaire
        d.ajouterObjet(new Chenille(d, new FormeAnimee(new Cercle(d.getLargeur() / 2, d.getHauteur() / 2, 20, 5f, Color.gray, Color.red), new AnimateurCercle(600, 400, 30, 25, 12)), 15, 10, false));
        // ajout chenille avec corps standard, déplacement rebond
        d.ajouterObjet(new Chenille(d, new FormeAnimee(new Cercle(d.getLargeur() / 2, d.getHauteur() / 2, 20, 5f, Color.gray, Color.red), new AnimateurRebond(d, 15, -3)), 15, 10, false));
