 ...
 */
public class TeteImage extends FormeCirculaire {
     ...
     */
    public TeteImage(int xInit, int yInit, BufferedImage img) {
        super(xInit, yInit, img.getWidth() /2, 0.0f, null, null);
        this.img = img;
    }
    ...
    public void dessiner(Graphics g) {
        g.drawImage(img, 
                this.x - this.rayon, this.y - this.rayon, this.x + rayon, this.y + this.rayon,
                0, 0, 63, 63, null);
    }
